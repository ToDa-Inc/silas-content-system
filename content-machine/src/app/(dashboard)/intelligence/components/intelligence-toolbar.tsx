...
type Props = {
  ...
  /**
   * `embedded` — smaller control + calmer status line for dense headers (e.g. Reels catalog).
   */
  ...
  return (
    ...
    >
      <button
        ...
        className={
          embedded
            ? "inline-flex h-9 min-w-[5.5rem] items-center justify-center gap-1.5 rounded-lg border border-zinc-200/90 bg-white/90 px-3 text-xs font-semibold text-zinc-800 shadow-sm outline-none transition-colors hover:border-zinc-300 hover:bg-zinc-50 focus-visible:ring-2 focus-visible:ring-zinc-400/40 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-50 dark:border-white/12 dark:bg-zinc-900/90 dark:text-app-fg-secondary dark:hover:bg-white/[0.06] dark:focus-visible:ring-offset-zinc-950 disabled:pointer-events-none disabled:opacity-45 " +
              (stale
                ? "border-amber-500/35 dark:border-amber-500/30"
                : "")
            : "inline-flex h-10 min-w-[6.5rem] items-center justify-center gap-2 rounded-xl border border-amber-500/50 bg-white px-4 text-sm font-semibold text-amber-800 shadow-sm outline-none transition-colors hover:border-amber-500/70 hover:bg-amber-50 focus-visible:ring-2 focus-visible:ring-amber-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-50 dark:bg-zinc-900/90 dark:text-amber-300 dark:hover:bg-amber-500/10 dark:focus-visible:ring-offset-zinc-950 disabled:pointer-events-none disabled:opacity-45"
        }
      >
